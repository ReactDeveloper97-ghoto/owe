...
const Elementary = () => {
    ...
    // Structured Data for Elementary Education Page
    const structuredData = {
        "@context": "https://schema.org",
        "@type": "Course",
        "name": "Elementary Education Program (K-5) - Our World of Education",
        "description": "Comprehensive elementary math program with three levels: Accelerated, Advanced, Honors. Build foundation for higher-level reasoning and logical thinking.",
        "provider": {
    ...
    const FAQ = [
        {
            ...
            para: 'The "Our World" comes from our approach - which is based on elite math schools, adapted to the U.S. environment. According to tradition - the study of mathematics is the pre-eminent tool of mental development. We teach math in a way that builds mathematical excellence, intellect and character.',
        },
        {
            id: '2',
        ...
        },
        {
            ...
            para: 'The goal of homework is to reinforce what was taught in class. Our teachers assign just enough to strengthen the skills developed in class. Homework should take approximately half the length of your child\'s lesson to complete.',
        },
        {
            id: '4',
            heading: 'How long are your classes? Can an elementary school child sit that long?',
            para: 'Our class-times vary depending on a child\'s age. Starting from 1.5 hours for kindergarteners to 2-4 hours in high school. In younger grades, we regularly mix activities and work with manipulatives to keep students engaged.',
        },
        {
            id: '5',
        ...
        },
        {
            ...
            para: 'The concepts we cover are fundamental and studied in depth from multiple angles. This doesn\'t lead to confusion but empowers students by deepening their understanding. Children master concepts that help them adapt to any school format.',
        },
        {
            id: '8',
    ...
    const strategies = [
        ...
        },
        {
            id: '3',
            heading: 'Challenge',
            para: 'Students regularly engage with problems for which the solutions are neither obvious nor easy, learning the particular thrill of accomplishment.',
            colorDark: '#fdf3b3',
            colorLight: '#ebd85e',
        },
        {
            id: '4',
            heading: 'Environment',
            para: 'Students are immersed in our classroom culture of conversation, debate, and verbalizing their thinking in a playful environment with peers.',
            colorDark: '#f8deb3',
            colorLight: '#feb746',
        },
    ];
    ...
    const programLevels = [
        {
            ...
            description: 'Often the best fit for new students, this curriculum is designed to meet students where they are, build their math foundation, and bring them to international standards.',
        },
        {
            level: 'II - Advanced Level',
            description: 'Most students continue to this level, where we offer a challenging mathematics curriculum that provides deep understanding, reasoning skills, and confidence for success.',
        },
        {
            level: 'III - Honors Level',
            description: 'This rigorous curriculum goes into great depth and employs competition-level problems. Many students in Honors also choose to participate in math competitions.',
        },
    ];
    ...
    return (
        <>
            <SEO
                title="Elementary Math Program (K-5) | Build Strong Foundation - Our World of Education"
                description="Comprehensive elementary math education with three learning levels. Build mathematical foundation, reasoning skills, and confidence for K-5 students. Free evaluation available."
                keywords="elementary math program, K-5 math, math foundation, elementary education, math for kids, after school math, math competition preparation"
                ...
                <div className={`min-h-screen ${theme === 'light' ? 'bg-white' : 'bg-gray-900'}`}>
                    <main>
                        ...
                        <section
                            ...
                            aria-label="Elementary Program Overview"
                        >
                                ...
                                <div className="hidden sm:block">
                                    <div className="min-h-[40vh] flex flex-col items-start justify-center">
                                        ...
                                        <Link
                                            ...
                                            aria-label="Schedule an evaluation for elementary program"
                                        >
                        ...
                        <section
                            ...
                            aria-label="Mobile Elementary Overview"
                        >
                                ...
                                <div className="grid md:grid-cols-2 gap-12 items-center">
                                    ...
                                    <div className="flex flex-col items-center">
                                        <figure>
                                            <img
                                                src={streitigy}
                                                alt="Educational strategy visualization"
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 items-center">
                                        ...
                                        <div className="aspect-video">
                                            <iframe
                                                ...
                                                title="Our World of Education Elementary Program Video"
                            ...
                            <div className="max-w-7xl mx-auto">
                                <div className="grid md:grid-cols-2 gap-8 mb-12">
                                    ...
                                    <p className="text-lg lg:text-xl text-gray-600 dark:text-gray-300">
                                        ...
                                        in their math and learning abilities overall.
                                    </p>
                                </div>
                            ...
                            <div className="max-w-7xl mx-auto">
                                <div className="grid md:grid-cols-2 gap-12 items-center">
                                    <div>
                                        <blockquote className="text-2xl italic text-gray-700 dark:text-gray-300 mb-6">
                                            <span className="text-4xl text-[#007698] dark:text-[#8bc540] font-bold mr-2">"</span>
                                            There's one Latin saying, "Non scholae sed vitae discimus," which means,
                                            "we do not learn for school but for life." That's what OWE provides:
                                            how to learn, how to comprehend, and how to apply.
                                            We couldn't ask for more for our child.
                                    ...
                                    <div>
                                        <img
                                            ...
                                            alt="Elementary student testimonial"
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 items-center">
                                        ...
                                        <div className="text-right">
                                            <Link
                                                ...
                                                aria-label="Schedule evaluation for elementary program"
                                            >
                                                Schedule an Evaluation
                                            </Link>
                                        </div>
