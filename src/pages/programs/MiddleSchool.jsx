...
const MiddleSchool = () => {
  ...
  // Structured Data for Middle School Program
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Course",
    "name": "Middle School Math Program (Grades 6-8) - Algebra & Geometry - Our World of Education",
    "description": "Comprehensive middle school mathematics program focusing on Algebra I, II, and Geometry. Three learning levels for grades 6-8 with competition preparation.",
    "provider": {
    ...
    "hasCourseInstance": {
      ...
      "educationalAlignment": {
        ...
        "targetName": "Grades 6-8 Mathematics"
      }
    }
  };
  ...
  const FAQ = [
    ...
    },
    {
      ...
      para: 'Math education is not complete without geometry. It is a new language that takes years to master, both from the perspective of advanced logical and spatial reasoning. Most public schools offer geometry over one year at most while some even less than that, but it takes multiple years to fully learn geometry. If your child is interested in competitions, geometry preparation is also necessary as geometry problems are regularly featured.',
    },
  ];
  ...
  const strategies = [
    ...
    },
    {
      id: '3',
      heading: 'Challenge',
      para: "Students are pushed out of their comfort zones to solve challenging problems that deepen their understanding and prepare them for tests and math competitions.",
      colorDark: '#fdf3b3',
      colorLight: '#ebd85e',
    },
    {
      id: '4',
      heading: 'Environment',
      para: "Students are immersed in scholarly discourse and debate, expected to present logical arguments to support their ideas, and regularly engage in healthy competition.",
      colorDark: '#f8deb3',
      colorLight: '#feb746',
    },
  ];
  ...
  return (
    <>
      <SEO
        title="Middle School Math Program (Grades 6-8) | Algebra & Geometry - Our World of Education"
        description="Comprehensive middle school mathematics program for grades 6-8 focusing on Algebra I, II, and Geometry. Three learning levels with competition preparation for AMC8, Math Kangaroo."
        keywords="middle school math, algebra for middle school, geometry for grades 6-8, math competition preparation, AMC8 preparation, Math Kangaroo, grades 6-8 mathematics"
      ...
      <Suspense fallback={<LoadingSpinner />}>
        <div className={`min-h-screen ${theme === 'light' ? 'bg-white' : 'bg-gray-900'}`}>
          <main>
            {/* Hero Section */}
            <section
              className={`min-h-[55vh] md:min-h-[76vh] pt-16 py-4 md:pt-20 px-4 md:px-16 ${theme === 'light' ? 'bg-[#d5d7d9e3]' : 'bg-gray-800'
                }`}
              aria-label="Middle School Program Overview"
            >
                ...
                <div className="hidden sm:block">
                  <div className="min-h-[40vh] flex flex-col items-start justify-center">
                    ...
                    <Link
                      ...
                      aria-label="Schedule an evaluation for middle school program"
                    >
            ...
            <section
              ...
              aria-label="Mobile Middle School Overview"
            >
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="flex flex-col items-center">
                    <figure>
                      <img
                        src={streitigy}
                        alt="Middle school educational strategy visualization"
                  ...
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="aspect-video">
                      <iframe
                        ...
                        title="Our World of Education Middle School Program Video"
              ...
              <div className="max-w-7xl mx-auto">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div>
                    <blockquote className="text-2xl italic text-gray-700 dark:text-gray-300 mb-6">
                      <span className="text-4xl text-[#007698] dark:text-[#8bc540] font-bold mr-2">"</span>
                      Dear Ms. R, With you, I gained a confidence in math I never had before.
                      You helped me have great grades in school and develop a strong work ethic.
                      You have been such a wonderful teacher.
                    ...
                    <div>
                      ...
                      <p className="text-xl font-semibold text-gray-700 dark:text-gray-300">7th grade</p>
                    </div>
                  </div>
                  <div>
                    <img
                      src={ElementaryTestimonial}
                      alt="Middle school student testimonial"
                ...
                <div className={`rounded-2xl p-8 md:p-12 ${theme === 'light' ? 'bg-[#8bc540]' : 'bg-[#007698]'
                  ...
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    <h2 className="text-3xl md:text-4xl font-bold">
                      Learn more about our middle school math program
                    </h2>
                    <div className="text-right">
                      <Link
                        to="/contacts"
                        ...
                        aria-label="Schedule evaluation for middle school program"
                      >
                        Schedule an Evaluation
                      </Link>
                    </div>
