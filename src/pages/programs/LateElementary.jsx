...
const LateElementary = () => {
  ...
  },
  {
    ...
    para: 'Students see mathematics as an interconnected world, deriving new knowledge from what they already know. This forms a deep understanding of concepts as well as an agility with which students are able to manipulate and apply them.',
    HtxtDark: '#90def3',
    HtxtLight: '#007698',
  },
  {
    id: '3',
    heading: ' Challenge',
    para: "We nudge students out of their comfort zones, exposing them to problems they're unable to immediately solve. This acquaints them with the particular thrill of accomplishment that comes with persisting through challenges.",
    HtxtDark: '#fdf3b3',
    HtxtLight: '#ebd85e',
  },
  {
    id: '4',
    heading: ' Environment',
    para: "In our classrooms, students compete with one another in a healthy, fun, and supported way. They are encouraged to debate and discuss their ideas, as well as verbalize their thinking to one another and to their teacher.",
    HtxtDark: '#f8deb3',
    HtxtLight: '#feb746',
  },]
  const FAQ = [{
  ...
  return (
    <div className={`${theme == 'light' ? 'bg-white' : 'bg-gray-800'}`}>
      ...
      <div className={`w-full h-full `}>
        {/*---------------------------------  programs hero ------------------------- */}
        <div className={`hero late-elementary-hero-img-container  min-h-[50vh] md:min-h-[66vh] bg-right! pt-16 py-4 md:pt-18 px-16 ${theme == 'light' ? 'bg-[#f0f0f0]' : 'bg-gray-700'} w-full`}>
        ...
        <div className={`hero-content pb-8 flex ${theme == 'light' ? 'bg-[#007698] text-white' : 'bg-gray-700 md:bg-white text-white '} items-center justify-center w-full sm:hidden w-full `}>
          <div className="content-text min-h-[40vh] flex flex-col items-center justify-start w-full">
            ...
            <p className={`px-2 leading-6 w-full font-normal text-gray-100!`}>
              We build understanding by challenging our students to reason through difficult and unfamiliar problems.             </p>
          </div>
          ...
          <div className={`containter rounded-lg p-2 md:p-0 w-full`}>
            <div className="uper-portion flex flex-col md:flex-row items-center justify-between">
              ...
              <p className={`leading-5 md:leading-8 text-lg lg:text-xl w-full lg:max-w-3/4 md:px-40 py-4  font-normal ${theme == 'light' ? 'text-[#007698]' : 'text-gray-200'} text-center md:text-start `}>
                ...
                with many participating in a variety of math competitions.</p>
            </div>
            <div className="lower-portion w-full">
                ...
                {results.map((item, index) => (
                  <div
                    ...
                    <div className="img-card  w-full leading-8 text-lg md:text-xl mb-4 md:mb-12 lg:text-2xl flex justify-center items-center">
                      ...
                      {results.length - 1 == index && <Link to={'/blog'}><span className={`absolute bottom-5  text-sm! btn-small ${theme == 'light' ? ' btn-small-light ' : ' btn-small-dark '} right-1/10`}>read more</span></Link>}
                    </div>
                  </div>
                ))}
              </div>
